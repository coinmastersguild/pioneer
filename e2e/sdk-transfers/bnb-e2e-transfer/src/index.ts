...
let ASSET = 'BNB'
let MIN_BALANCE = process.env['MIN_BALANCE_BNB'] || "0.04"
let TEST_AMOUNT = process.env['TEST_AMOUNT'] || "0.0001"
let spec = process.env['URL_PIONEER_SPEC'] || 'https://pioneers.dev/spec/swagger.json'
let wss = process.env['URL_PIONEER_SOCKET'] || 'wss://pioneers.dev'
let NO_BROADCAST = process.env['E2E_BROADCAST'] || true
let FAUCET_BNB_ADDRESS = process.env['FAUCET_BNB_ADDRESS'] || 'thor1wy58774wagy4hkljz9mchhqtgk949zdwwe80d5'
let FAUCET_BCH_ADDRESS = process.env['FAUCET_BNB_ADDRESS'] || 'qrsggegsd2msfjaueml6n6vyx6awfg5j4qmj0u89hj'
...
const test_service = async function () {
    ...
    try {
        ...
        let seedChains = ['ethereum','thorchain','bitcoin','binance']
        ...
        let amountTestNative = baseAmountToNative("BNB",TEST_AMOUNT)
