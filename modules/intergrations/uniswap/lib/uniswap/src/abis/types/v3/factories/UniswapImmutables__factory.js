...
exports.UniswapImmutables__factory = void 0;
...
class UniswapImmutables__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (args.length === 1) {
...
exports.UniswapImmutables__factory = UniswapImmutables__factory;
