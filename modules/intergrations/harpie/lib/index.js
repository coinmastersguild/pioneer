...
var HARPIE_API_KEY = process.env['HARPIE_API_KEY'] || "KEEPKEYTEST";
if (!HARPIE_API_KEY)
    throw Error("api key required! set env HARPIE_API_KEY");
module.exports = {
    validateTransaction: function (from, to, data) {
        return submit_tx(from, to, data);
    },
    validateTransactionv2: function (from, to, data) {
        return submit_tx_v2(from, to, data);
    },
};
var submit_tx_v2 = function (from, to, data, value) {
    return __awaiter(this, void 0, void 0, function () {
        var tag, payload, body, resp, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios.post(body.url, body.data)];
                case 2:
                    resp = _a.sent();
