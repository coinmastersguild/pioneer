...
//
const bootloaderHashToVersion:any = {
...
export const normalizeWebUsbFeatures = (features:any) => {
...
export const normalizeHidFeatures = (features:any) => {
    if (!features) return null
...
export const atob = (str: any) => Buffer.from(str, 'base64').toString('binary');

export const base64toHEX = (base64:any) => {
    var raw = atob(base64);
    var HEX = '';
