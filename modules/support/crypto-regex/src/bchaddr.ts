 ...
 */
function detectAddressFormat (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function detectAddressNetwork (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function detectAddressType (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function toLegacyAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function toBitpayAddress (address:any) {
    var decoded = decodeAddress(address)
 ...
 * @throws {InvalidAddressError}
 */
function toCashAddress (address:any) {
    var decoded = decodeAddress(address)
 ...
 * @throws {InvalidAddressError}
 */
function decodeBase58Address (address:any) {
    try {
 ...
 * @throws {InvalidAddressError}
 */
function decodeCashAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function decodeCashAddressWithPrefix (address:any) {
    try {
 ...
 * @returns {string}
 */
function encodeAsLegacy (decoded:any) {
 ...
 * @returns {string}
 */
function encodeAsBitpay (decoded:any) {
 ...
 * @returns {string}
 */
function encodeAsCashaddr (decoded:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isLegacyAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isBitpayAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isCashAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isMainnetAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isTestnetAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isP2PKHAddress (address:any) {
 ...
 * @throws {InvalidAddressError}
 */
function isP2SHAddress (address:any) {
...
function InvalidAddressError() {
    ...
    error.message = 'Received an invalid Bitcoin Cash address as input.';
    return error;
}
