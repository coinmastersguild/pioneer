 ...
 */
function encode(prefix:any, type:any, hash:any) {
 ...
 * @returns {boolean}
 */
function isValidPrefix(prefix:any) {
 ...
 * @returns {Uint8Array}
 */
function prefixToUint5Array(prefix:any) {
 ...
 * @returns {Uint8Array}
 */
function checksumToUint5Array(checksum:any) {
 ...
 * @throws {ValidationError}
 */
function getType(versionByte:any) {
 ...
 * @returns {number}
 */
function getHashSize(versionByte:any) {
 ...
 * @returns {Uint8Array}
 */
function toUint5Array(data:any) {
 ...
 * @throws {ValidationError}
 */
function fromUint5Array(data:any) {
 ...
 * @returns {boolean}
 */
function validChecksum(prefix:any, payload:any) {
    var prefixData = concat(prefixToUint5Array(prefix), new Uint8Array(1));
 ...
 * @returns {boolean}
 */
function hasSingleCase(string:any) {
