...
let get_balance = async function(address,token){
...
let get_txs_by_height = async function(height,address){
	let tag = TAG + " | get_txs_by_height | "
	let output = {}
	try{
...
let get_block_remote = async function(height){
	let tag = TAG + " | get_block | "
	let output = {}
	try{
		log.debug("checkpoint! ",height)
...
let broadcast_transaction = async function(rawTx){
